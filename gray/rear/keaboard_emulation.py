...
def do_button_stream(string, sleep_delay=0.1):
    for button_event in keyboard_stream(string):
        SendInput(button_event)
...
# SendInput(Keyboard(win32con.VK_RETURN))
# import time
# time.sleep(2)
# SendInput(Keyboard(win32con.VK_RETURN, win32con.KEYEVENTF_KEYUP))
